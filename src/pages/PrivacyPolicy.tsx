    ...
    <div className="bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-4 text-gray-700">
          <p>
            Questa informativa descrive come trattiamo i dati personali degli utenti in conformità al GDPR.
          </p>
          <p>
            Titolare: Franzè Garage, Via Prospero Rizzini 6/A, Cazzago San Martino (BS), P.IVA IT04401580982.
          </p>
          <p>
